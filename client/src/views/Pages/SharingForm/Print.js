      ...
      <div style={{ width: '100%', height: '100%', backgroundColor: 'white' }}>
        <div style={{ padding: 50, paddingTop: 30 }}>
          ...
          >
            ...
            <div>
              <h5><strong>Order #: {order_number}</strong></h5>
            </div>
          </div>
          <div
            style={{
          ...
          >
            <div style={{ width: '50%' }}>
              ...
              <h6 style={h6Style}>{mohawk_account_number}</h6>
            </div>
            <div>
              ...
              <h6 style={h6Style}>Payment Method: Mohawk</h6>
              <h6 style={h6Style}>
                Payment Status:{' '}
                {mohawk_order_status === 'pending'
                  ? 'Mohawk-Pending'
                  : mohawk_order_status === 'rejected'
                    ? 'Mohawk-Not Approved'
                    : 'Mohawk-Approved'}
              </h6>
              <h6 style={h6Style}>
          ...
          >
            <div style={{ marginTop: 20 }}>{this.props.trackingNumbers}</div>
